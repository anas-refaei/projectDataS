...
public:
	...
	// Status Bar Display for Simulation
	void PrintStatusBar(int timeStep,
		int waitN, int waitG, int waitV, int waitQ, int waitC,  // Added Q and C
		int availN, int availG, int availV, int availQ, int availC,  // Added Q and C
		const vector<string>& assignments,
		int servedN, int servedG, int servedV, int servedQ, int servedC) const;  // Added Q and C
	...
	// Delay function for Step-by-Step mode
